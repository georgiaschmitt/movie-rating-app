...
def most_and_least_common_type(treats):
    ...
    >>> treat1 = get_treats()
    >>> most_and_least_common_type(treat1)
    ('dessert', 'drink')

    >>> treat2 = [{'type':'dessert'}]
    >>> most_and_least_common_type(treat2)
    ('dessert', 'dessert')

    >>> treat3 = [{'type':'dessert'}, {'type':'appetizer'}]
    >>> most_and_least_common_type(treat3)
    ('dessert', 'dessert')

    >>> treat4 = []
    >>> most_and_least_common_type(treat4)
    (None, None)
